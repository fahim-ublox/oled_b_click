...
public:
	...
	/** Thread to get message from queue and pass it to write_top method */
    void scroll_top();
    
	/** Thread to get message from queue and pass it to write_bottom method */
    void scroll_bottom();
    
	/** Method for application to write a message into top row queue
	 *  @param message ASCII string to be displayed. Maximum length of string is 255 Byte
     */
    void queue_put_top(unsigned char * message);
    
	/** Method for application to write a message into bottom row queue
	 *  @param message ASCII string to be displayed. Maximum length of string is 255 Byte
     */
